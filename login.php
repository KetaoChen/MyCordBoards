...
if( $_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (empty($enteredPassword)) {
			array_push($error_msg,  "PIN cannot be empty.");
	}
    ...
    if ( !empty($enteredEmail) && !empty($enteredPassword) )   { 
        ...
        if (!empty($result) && ($count > 0) ) {
            ...
            if (password_verify($enteredPassword, $storedHash) ) {
                ...
                header(REFRESH_TIME . 'url=homescreen.php');		//to view the password hashes and login success/failure
                
            } else {
                array_push($error_msg, "Login failed, please try again ");
...
<body>
    <div id="main_container">
        <div id="header">
            <div class="logo">
                <img src="img/team053_mainheader.png" style="opacity:0.8;background-color:E9E5E2;" border="0" alt="" title="GT Online Logo"/>
            </div>
        </div>
            ...
            <div class="text_box">
                ...
                <form action="login.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="login_form_row">
                        ...
                        <input type="password" name="password" value="m123" class="login_input"/>
                    </div>
